...
$sql = "insert into tb_aluno (alu_nome,alu_data_nascimento,alu_sexo,alu_cep,alu_logradouro,alu_numero,alu_complemento,alu_cidade,alu_estado,alu_email,alu_telefone,alu_celular,alu_escolaridade,alu_serie,alu_ano_conclusao,alu_escola,alu_objetivo) values ('$nome', '$data_nascimento', '$sexo','$cep','$logradouro','$numero','$complemento','$cidade','$estado','$email','$telefone','$celular','$escolaridade','$serie','$ano_conclusao','$escola','$objetivo')";
